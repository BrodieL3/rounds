...
Current slice in development: none. Last completed slice: Architecture hardening — Conversation Message send and Conversation surface. The original Friends-first implementation track is complete through text DMs, group chats, review companion tags, venue/review links, unlisted Rating shares, polls, photos, location pins, voice notes, safety basics, and message reactions/reply quotes.
