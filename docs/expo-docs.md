...
- [Precompiled Expo Modules](https://docs.expo.dev/guides/prebuilt-expo-modules): Learn how precompiled Expo Modules reduce native build times on Android and iOS.
...
- [Workflows REST API](https://docs.expo.dev/eas/workflows/rest-api): Trigger a workflow and check its status from your own systems with the EAS REST API.
...
- [EAS Observe dashboard](https://docs.expo.dev/eas/observe/dashboard): View performance metrics, filter by platform, environment, and release, and investigate individual sessions in the EAS Observe dashboard.
- [EAS Update download performance](https://docs.expo.dev/eas/observe/eas-update): Track how long EAS Update OTA bundles take to download on real user devices, with per-update breakdowns in the EAS Observe dashboard.
- [User-defined events](https://docs.expo.dev/eas/observe/events): Log named events from your app to track custom signals visible in the EAS Observe dashboard.
...
- [React Navigation integration](https://docs.expo.dev/eas/observe/integrations/react-navigation): Track per-screen render and interactive timings by enabling the React Navigation integration for EAS Observe.
...
- [NavigationBar](https://docs.expo.dev/versions/latest/sdk/ui/jetpack-compose/navigationbar): A Jetpack Compose NavigationBar component for Material 3 bottom navigation.
