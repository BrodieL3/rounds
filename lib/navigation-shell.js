...
const ROUTE_METADATA = Object.freeze({
  ...
  add: Object.freeze({ name: 'add', title: 'Rate a venue', role: 'rate-venue', presentation: 'modal', animation: 'slide_from_bottom', header: Object.freeze({ shown: false, customHeaderException: true }) }),
  'edit-profile': Object.freeze({ name: 'edit-profile', title: 'Edit profile', role: 'profile-edit', presentation: 'modal', animation: 'slide_from_bottom', header: Object.freeze({ shown: false, customHeaderException: true }) }),
  ...
  'plus-menu': Object.freeze({ name: 'plus-menu', title: 'Plus', role: 'plus-menu', presentation: 'transparentModal', animation: 'fade', header: Object.freeze({ shown: false, customHeaderException: true }), contentStyle: Object.freeze({ backgroundColor: 'transparent' }) }),
  ...
  signup: Object.freeze({ name: 'signup', title: 'Create account', role: 'auth', header: Object.freeze({ shown: false }) }),
  onboarding: Object.freeze({ name: 'onboarding', title: 'Set up your profile', role: 'auth', header: Object.freeze({ shown: false }) }),
});

const ROOT_STACK_ROUTE_NAMES = Object.freeze(['index', '(tabs)', 'add', 'edit-profile', 'post', 'conversation', 'venue', 'search', 'user', 'plus-menu', 'login', 'signup', 'onboarding']);
...
function buildStackScreen(route) {
  ...
  if (metadata.animation) options.animation = metadata.animation;
  if (metadata.sheet) {
