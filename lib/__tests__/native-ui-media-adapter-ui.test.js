...
describe('native UI media adapter', () => {
  ...
  test('Discover renders avatars and review media through shared MediaImage primitive', () => {
    ...
    expect(source).toContain('<MediaImage source={{ uri: avatarPhoto }} style={styles.avatar}');
